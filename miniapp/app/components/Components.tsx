  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <Card title="AirtimePlus">
        ...
        <Button
          onClick={() => setActiveTab("add number")}
...
export function AddNumber({ setActiveTab }: AddNumberProps) {
    // data.json should export an object like:
    // { countries: string[], networks: { [country: string]: string[] } }
    ...
    const handleAdd = () => {
      // example logic: log values and switch tab
        ...
        <Card title="Add Number">
          <div className="space-y-4">
            ...
            <div className="text-right">
              <Button onClick={handleAdd} icon={<Icon name="plus" size="sm" />}>
                Add
              </Button>
            </div>
          </div>
  ...
  // inside Components.tsx (below your other exports)


type ConfirmNumberProps = {
  setActiveTab: (tab: string) => void;
};
      ...
      <Card title="Confirm Number">
        <div className="space-y-4">
          <p className="text-[var(--app-foreground-muted)]">
            Please enter the OTP number sent to your phone
          </p>
          <input
            type="text"
            inputMode="numeric"
          ...
          />
          <div className="text-right">
            <Button onClick={handleConfirm} disabled={otp.length < 6}>
              Confirm
            </Button>
          </div>
        </div>
